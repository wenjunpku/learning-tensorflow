...
class NeuralNetwork:
    ...
    def train(self, training_inputs, training_outputs):
        ...
        for h in range(len(self.hidden_layer.neurons)):
            ...
            # We need to calculate the derivative of the error with respect to
    ...
    def calculate_total_error(self, training_sets):
        ...
        for t in range(len(training_sets)):
            ...
            for o in range(len(training_outputs)):
                total_error += self.output_layer.neurons[o].\
...
class Neuron:
    ...
    # Determine how much the neuron's total input has to change to move closer
    # to the expected output
    #
    # Now that we have the partial derivative of the error with respect to
    # the output (∂E/∂yⱼ) and
    # the derivative of the output with respect to the total net input
    # (dyⱼ/dzⱼ) we can calculate
    ...
    #
    # Alternative, you can use (target - output), but then need to add it
    # during backpropagation [3]
    #
    # Note that the actual output of the output neuron is often written as yⱼ
    # and target output as tⱼ so:
    # = ∂E/∂yⱼ = -(tⱼ - yⱼ)
